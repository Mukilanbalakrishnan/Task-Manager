...
//           <h2 className="sidebar-title">EMS Manager</h2>
//           <ul className="sidebar-links">
//             <li onClick={() => setActivePage("task")}>Task Assignment</li>
//             <li onClick={() => setActivePage("leave")}>Leave Approval</li>
//             <li onClick={() => setActivePage("performance")}>Task Completion Status_Employee</li>
//             <li onClick={() => setActivePage("attendance")}>Attendance Tracking</li>
//             {/* <li onClick={() => setActivePage("analytics")}>Report Analytics</li> */}
//             <li onClick={() => setActivePage("payroll")}>Manager View Payroll</li>
//           </ul>
//         </div>
//       )}
